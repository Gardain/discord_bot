async def help(msg):
    await msg.channel.send(f'Привет, {msg.author.mention}\n'
                           ...
                           f':slot_machine: !games - выводит список возможных игр :slot_machine:\n\n'
                           ...
                           f':blue_book:  !translate - переводит с английского на русский и наоборот '
                           f' пример: !translate en|ru *ваш текст*, если вы хотите перевести с русского на английский:'
                           f' !translate ru|en *ваш текст*) :blue_book:\n\n'
                           f':x:!ban - забанить пользователя (доступен только для обладателей роли'
                           f' :boom:Суперадмин) :x:\n\n'
                           f':x:!kick - кикнуть пользователя (доступен только для обладателей роли'
                           f' :boom: Админ) :x:\n\n'
