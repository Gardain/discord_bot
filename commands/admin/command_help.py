async def help(msg):
    await msg.channel.send(f'Привет, {msg.author.mention}\n'
                           ...
                           f'(что бы изменить язык, после команды введите "язык, на котором будет написан текст|язык, в который нужно перевести текст'
                           f'", пример:  !translate en|ru *ваш текст*) :blue_book:\n\n'
